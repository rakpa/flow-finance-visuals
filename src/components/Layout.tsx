...
const Layout = ({ children }: LayoutProps) => {
  ...
  return (
    <div className="min-h-screen flex w-full bg-background">
      ...
      <aside className={cn(
        "fixed inset-y-0 z-50 flex w-72 flex-col bg-orange-500 text-white shadow-sm transition-transform h-screen lg:h-auto lg:static lg:translate-x-0",
        sidebarOpen ? "translate-x-0" : "-translate-x-full"
      )}>
        <div className="flex h-16 items-center border-b border-orange-600 px-4">
